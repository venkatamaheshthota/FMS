        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 inline-block max-w-[160px]">
                <Image
                  src="/images/logo/florida_logo.png"
                  alt="logo"
                  width={140}
                  height={30}
              ...
              <div className="-mx-3 flex items-center">
                <a
                  ...
                  href="https://www.facebook.com/FloridaMainStreet/"
                ...
                <a
                  aria-label="social link"
                  href="https://www.instagram.com/floridamainstreet/"
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <svg
                    width="22"
              ...
              <ul>
                ...
                <li>
                  <a
                    ...
                    className="mb-3 inline-block text-base text-gray-7 hover:text-primary"
                  >
                    Preservation of main street Conference
                  </a>
                </li>
              </ul>
            </div>
          ...
          {/* <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-4/12">
            <div className="mb-12 w-full">
              <p className="mb-12 max-w-[370px] text-base text-gray-7" style={{fontWeight: 'bold', fontSize: '21px'}}>
              Florida Department of State<br/>
              Phone: 850.245.6500
              </p>
              <p className="mb-12 max-w-[270px] text-base text-gray-7">
            ...
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <a
                    href="https://dos.fl.gov/privacy-policy/"
                    className="px-3 text-base text-gray-7 hover:text-white hover:underline"
                  >
                    Privacy policy
                  </a>
                  <a
                    href="https://dos.fl.gov/accessibility/"
                    className="px-3 text-base text-gray-7 hover:text-white hover:underline"
                  >
                    Accessibility
                  </a>
                  <a
                    href="https://dos.fl.gov/site-map/"
                    className="px-3 text-base text-gray-7 hover:text-white hover:underline"
                  >
                    Site Map
                  </a>
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                ...
                © 2024 State of Florida, {" "}
                  <a
                    href="https://dos.fl.gov/copyright/"
