      ...
      >
        <div className="container">
          <div className="relative flex items-center">
            ...
            <div className="flex w-full justify-end">
              <span className="input-group-text flex items-center whitespace-nowrap rounded px-3 py-1.5 text-center text-base font-normal" id="basic-addon2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill={sticky ? "white" : "currentColor"} className="h-6 w-6">
