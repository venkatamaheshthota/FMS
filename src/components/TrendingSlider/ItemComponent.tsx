...
const ItemComponent = () => {
  let id= 1;
  let name= "Victory Bridge - Chattahoochee Main Street"
  let designation= "Built in 1922 by the Masters and Mullen Construction Company of Cleveland, Ohio"
    let image =  "/images/team/bridge1.jpeg"
    let facebookLink= "/#"
    let twitterLink= "/#"
    let instagramLink= "/#"
  ...
  //   team;
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4 positioned-text">
      <div className="shadow-testimonial dark:bg-dark group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 dark:shadow-none">
        <div className="text-center">
          ...
          <p className="text-body-color dark:text-dark-6 mb-5 text-sm">
            {"Florida Main Street is dedicated to revitalizing communities across the state. The cumulative success of the Main Street Programs at the local level has earned this revitalization strategy the reputation as one of the most powerful economic tools in the nation. "}
          </p>
